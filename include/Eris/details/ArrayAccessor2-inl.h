...
template <typename T>
ArrayAccessor<T, 2>::ArrayAccessor() : _size(), _data(nullptr) {}
...
// ConstArrayAccessor<T, 2> implementations

template <typename T>
ConstArrayAccessor<T, 2>::ConstArrayAccessor() : _size(), _data(nullptr) {}
