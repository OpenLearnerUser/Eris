...
namespace Eris
{
    ...
    public:
        ...
        //! Constructs vector with given x, y and z values.
    ...
    template <>
    constexpr Vector3F zero<Vector3F> = Vector3F(0.f, 0.f, 0.f);

    //! Returns double-type zero vector.
    template <>
    constexpr Vector3D zero<Vector3D> = Vector3D(0., 0.,0.);
