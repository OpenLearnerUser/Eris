...
namespace Eris
{
    ...
    VectorUnaryOp<T, E, Op>::VectorUnaryOp(const E &e_) : _e(e_) {}
    ...
    VectorBinaryOp<T, E1, E2, Op>::VectorBinaryOp(const E1 &e1, const E2 &e2)
        : _e1(e1), _e2(e2) {}
    ...
    {
        return _op(_e1[i], _e2[i]);
    }

    // MARK: VectorScalarBinaryOp
